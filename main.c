...
int init(){
    const char* msgs[] = {"0. Quit", "1. Add Vertex", "2. Add Edge", "3. Delete Vertex",
                          ...
                          "8. Strongly Connected Components", "9. Show Route Between People", "10. Traverse"};
    const int NMsgs = sizeof(msgs)/sizeof(msgs[0]);
    int (*fptr[])(Graph* const) = {NULL, D_AddVertex, D_AddEdge, D_DeleteVertex, D_DeleteEdge,
                                   D_EditVertex, D_EditEdge, D_Show, D_StronglyConnectedComponents,
                                   D_ShowRouteBetweenPeople, D_Traverse};
    Graph graph = {0, NULL};
    int res = 0;
    int rc = 0;
